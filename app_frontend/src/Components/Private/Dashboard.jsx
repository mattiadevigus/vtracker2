                    ...
                    <div className="container row">
                        ...
                        <div className="col-8 col-lg-6">
                            <div className="tab-content" id="nav-tabContent">
                                ...
                                <div className="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list"><h5>So this is your first start. Okay, have you changed your login credentials yet? No? What are you waiting for? Open your config.json file and edit them to your liking. Don't worry, your username and password are safe: =)</h5> <hr /> <h5>Now it's time to set the ACC Server results folder path. To do this, open the config.json file again and paste the path. Easy isn't it?</h5></div>
