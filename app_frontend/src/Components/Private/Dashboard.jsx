                    ...
                    <div className="container row">
                        ...
                        <div className="col-8 col-lg-6">
                            <div className="tab-content" id="nav-tabContent">
                                ...
                                <div className="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list"><i className="fas fa-info fa-3x"></i><h5>BETA 2. I ask you to
                                    <hr />
                                    <ul>
                                        <li>Ride on the tracks of your choice</li>
                                        ...
                                        <li>Provide feedback on the webapp and tracking system. If you find bug, please report!</li>
                                    </ul>
                                    </h5>
                                </div>
                            </div>
